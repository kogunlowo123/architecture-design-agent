...
from archagent.errors import ProviderError, TransientProviderError
from archagent.logging_setup import JsonFormatter, RedactingTextFormatter, configure_logging
from archagent.providers import AnthropicChatClient, OpenAIChatClient
...
class TestLogging:
    def _record(self, message: str, **extra: object) -> logging.LogRecord:
        record = logging.LogRecord("archagent.t", logging.WARNING, __file__, 1, message, None, None)
